...
set_property -dict { PACKAGE_PIN B14   IOSTANDARD LVCMOS33 } [get_ports { Vaux8_v_p }]; #IO_L2P_T0_AD8P_15 Sch=ad_p[8]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { Vaux8_v_n }]; #IO_L2N_T0_AD8N_15 Sch=ad_n[8]
set_property -dict { PACKAGE_PIN D16   IOSTANDARD LVCMOS33 } [get_ports { Vaux3_v_p }]; #IO_L9P_T1_DQS_AD3P_15 Sch=ad_p[3]
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { Vaux3_v_n }]; #IO_L9N_T1_DQS_AD3N_15 Sch=ad_n[3]
